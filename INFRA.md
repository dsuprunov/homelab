...
|-------------------------------|-------------------|-------:|-----:|-------:|-------:|-------------------|------------------------------|
| `vm-coredns.home.arpa`        | `192.168.178.205` | 1 vCPU | 1 GB |   8 GB |        | `ns.home.arpa`    |                              |
| `vm-nas.home.arpa`            | `192.168.178.206` | 1 vCPU | 1 GB |   8 GB |  32 GB | `nas.home.arpa`   |                              |
| `vm-vault-01.home.arpa`       | `192.168.178.207` | 1 vCPU | 2 GB |   8 GB |        | `vault.home.arpa` | https://vault.home.arpa:8200 |
