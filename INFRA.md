...
|   231 | `vm-k8s-control-01` | `192.168.178.231` | `30-kubeadm`/`40-talos` | Active   | K8s control plane | 2 vCPU | 4 GB |  32 GB |        |                   |
|   232 | `vm-k8s-control-02` | `192.168.178.232` | `30-kubeadm`/`40-talos` | Active   | K8s control plane | 2 vCPU | 4 GB |  32 GB |        |                   |
|   233 | `vm-k8s-control-03` | `192.168.178.233` | `30-kubeadm`/`40-talos` | Active   | K8s control plane | 2 vCPU | 4 GB |  32 GB |        |                   |
|   236 | `vm-k8s-worker-01`  | `192.168.178.236` | `30-kubeadm`/`40-talos` | Active   | K8s worker node   | 2 vCPU | 4 GB |  32 GB |  32 GB |                   |
|   237 | `vm-k8s-worker-02`  | `192.168.178.237` | `30-kubeadm`/`40-talos` | Active   | K8s worker node   | 2 vCPU | 4 GB |  32 GB |  32 GB |                   |
|   238 | `vm-k8s-worker-03`  | `192.168.178.238` | `30-kubeadm`/`40-talos` | Active   | K8s worker node   | 2 vCPU | 4 GB |  32 GB |  32 GB |                   |
